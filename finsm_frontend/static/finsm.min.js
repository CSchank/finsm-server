...
var $author$project$Main$initAppModel = $author$project$BetterUndoList$fresh(
	{
	...
	function (msg, model) {
		...
		switch (msg.$) {
			...
			case 'SaveMachine':
				return _Utils_Tuple2(
					model,
					A6($author$project$SaveLoad$saveMachine, model.machineMetadata.name, model.machineMetadata.description, model.appModel.present.sharedModel.machine, model.machineMetadata.id, model.appModel.present.simulatingData.tapes, $author$project$Main$MachineSaveResponse));
...
var $author$project$Main$SaveMachine = {$: 'SaveMachine'};
	...
	return $MacCASOutreach$graphicsvg$GraphicSVG$group(
		_List_fromArray(
			[
				...
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$move,
					_Utils_Tuple2(((-winX) / 2) + 250, (winY / 2) - 20),
					A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$filled,
						$MacCASOutreach$graphicsvg$GraphicSVG$black,
						A2(
				...
				$MacCASOutreach$graphicsvg$GraphicSVG$move,
				_Utils_Tuple2(((-winX) / 2) + 700, (winY / 2) - 20),
				A5($author$project$Utils$textBox, model.machineMetadata.name, 1000, 20, 'Machine Name', $author$project$Main$TypeName)),
				A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$notifyTap,
				$author$project$Main$SaveMachine,
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$move,
					_Utils_Tuple2(((-winX) / 2) + 183, (winY / 2) - 15),
					$MacCASOutreach$graphicsvg$GraphicSVG$group(
						_List_fromArray(
							[
								A3(
								...
								A2(
									...
									$MacCASOutreach$graphicsvg$GraphicSVG$fixedwidth(
										$MacCASOutreach$graphicsvg$GraphicSVG$centered(
											$MacCASOutreach$graphicsvg$GraphicSVG$text('Save')))))
							]))))
			]));
};
...
var $author$project$Main$main = $MacCASOutreach$graphicsvg$GraphicSVG$app(
	{
		init: F3(
			function (flags, url, key) {
				return _Utils_Tuple2(
					{
						appModel: $author$project$Main$initAppModel,
						editingName: false,
						environment: $author$project$Environment$init,
						loginDialog: false,
