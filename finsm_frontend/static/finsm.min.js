...
var $author$project$Main$GetLoginStatus = {$: 'GetLoginStatus'};
...
var $author$project$Main$LoginStatusChange = function (a) {
...
var $author$project$Main$loginStatusDecoder = A2(
	$elm$json$Json$Decode$andThen,
	function (loggedIn) {
		return loggedIn ? A2(
			$elm$json$Json$Decode$map,
			$author$project$Main$LoggedIn,
			A2($elm$json$Json$Decode$field, 'email', $elm$json$Json$Decode$string)) : $elm$json$Json$Decode$succeed($author$project$Main$NotLoggedIn);
	},
...
var $author$project$Main$getLoginStatus = A2(
	$elm$http$Http$send,
	$author$project$Main$LoginStatusChange,
	A3($elm$http$Http$post, '/accounts/loginstate/', $elm$http$Http$emptyBody, $author$project$Main$loginStatusDecoder));
...
var $author$project$Main$Building = function (a) {
	return {$: 'Building', a: a};
};
...
var $author$project$Main$initAppRecord = {
	appState: $author$project$Main$Building($author$project$Building$init),
...
var $author$project$Main$LoadNotOpen = {$: 'LoadNotOpen'};
var $author$project$Main$initSaveModel = {
	editingName: false,
	lastSaved: $elm$time$Time$millisToPosix(0),
	loadDialog: $author$project$Main$LoadNotOpen,
	loginState: $author$project$Main$NotLoggedIn,
	machineMetadata: {
...
var $author$project$Main$Exporting = function (a) {
	return {$: 'Exporting', a: a};
};
var $author$project$Main$ListLoadResponse = function (a) {
	return {$: 'ListLoadResponse', a: a};
};
var $author$project$Main$LoadLoading = {$: 'LoadLoading'};
var $author$project$Main$LoadMachineResponse = function (a) {
	return {$: 'LoadMachineResponse', a: a};
};
var $author$project$Main$LoadOpen = function (a) {
	return {$: 'LoadOpen', a: a};
};
var $author$project$Main$MachineSaveResponse = function (a) {
	return {$: 'MachineSaveResponse', a: a};
};
var $author$project$Main$Simulating = function (a) {
...
var $author$project$SaveLoad$LoadMetadata = F4(
	function (id, name, date, description) {
		return {date: date, description: description, id: id, name: name};
	});
var $elm$json$Json$Decode$map4 = _Json_map4;
var $author$project$SaveLoad$decodeMetadataV1 = A5(
...
var $author$project$SaveLoad$loadList = function (toMsg) {
	return A2(
		$elm$http$Http$send,
		toMsg,
		A3($elm$http$Http$post, '/api/machine/list', $elm$http$Http$emptyBody, $author$project$SaveLoad$decodeMachineList));
};
var $author$project$SaveLoad$LoadPayload = F2(
	function (machine, tapes) {
		return {machine: machine, tapes: tapes};
	});
...
var $author$project$Machine$machineDecoder = $author$project$Machine$machineDecoderV1;
var $author$project$SaveLoad$decodeLoadPayload = A3(
	$elm$json$Json$Decode$map2,
...
var $author$project$Main$moduleUpdate = F9(
	function (env, mMsg, mModel, pModel, model, msgWrapper, appStateWrapper, setpModel, mUpdate) {
		...
		var cp = A2($elm$core$Debug$log, 'unsavedChanges', sm.unsavedChanges);
		var _v0 = A3(
			mUpdate,
			env,
...
var $author$project$SaveLoad$encodeMachinePayloadV1 = F5(
	function (name, desc, machine, uuid, inputTape) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
...
var $author$project$SaveLoad$saveMachine = F6(
	function (name, desc, machine, uuid, inputTape, toMsg) {
		return A2(
			$elm$http$Http$send,
			toMsg,
			A3(
				...
				'/api/machine/save',
				$elm$http$Http$jsonBody(
					A5($author$project$SaveLoad$encodeMachinePayload, name, desc, machine, uuid, inputTape)),
...
var $author$project$Main$update = F2(
	function (msg, model) {
		...
		switch (msg.$) {
			...
			case 'SMsg':
				...
				if (_v2.$ === 'Simulating') {
					...
					return A9(
						...
						$author$project$Main$Simulating,
						F2(
							function (pm, am) {
								return _Utils_update(
									am,
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							saveModel: _Utils_update(
								sm,
								{loadDialog: $author$project$Main$LoadLoading})
						}),
					$author$project$SaveLoad$loadList($author$project$Main$ListLoadResponse));
			case 'GetLoginStatus':
				return _Utils_Tuple2(model, $author$project$Main$getLoginStatus);
			...
			case 'TypeName':
				var n = msg.a;
				var meta = model.saveModel.machineMetadata;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
			...
			case 'SaveMachine':
				return _Utils_Tuple2(
					model,
					A6($author$project$SaveLoad$saveMachine, model.saveModel.machineMetadata.name, model.saveModel.machineMetadata.description, model.appModel.present.sharedModel.machine, model.saveModel.machineMetadata.id, model.appModel.present.simulatingData.tapes, $author$project$Main$MachineSaveResponse));
			...
			case 'GetTime':
				...
				return _Utils_Tuple2(
					...
					sm.unsavedChanges ? A6($author$project$SaveLoad$saveMachine, model.saveModel.machineMetadata.name, model.saveModel.machineMetadata.description, model.appModel.present.sharedModel.machine, model.saveModel.machineMetadata.id, model.appModel.present.simulatingData.tapes, $author$project$Main$MachineSaveResponse) : $elm$core$Platform$Cmd$none);
			case 'ListLoadResponse':
				var response = msg.a;
				var _v10 = A2($elm$core$Debug$log, 'machineListResponse', response);
				if (_v10.$ === 'Ok') {
					var machineList = _v10.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								saveModel: _Utils_update(
									sm,
									{
										loadDialog: $author$project$Main$LoadOpen(machineList)
									})
							}),
						$elm$core$Platform$Cmd$none);
				} else {
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							saveModel: _Utils_update(
								sm,
								{loadDialog: $author$project$Main$LoadNotOpen, machineMetadata: meta})
						}),
					A2($author$project$SaveLoad$loadMachine, meta.id, $author$project$Main$LoadMachineResponse));
			case 'LoadMachineResponse':
				var response = msg.a;
				var _v11 = A2($elm$core$Debug$log, 'loadMachineResponse', response);
				if (_v11.$ === 'Ok') {
					var loadPayload = _v11.a;
...
var $author$project$Main$EditMachineName = {$: 'EditMachineName'};
var $author$project$Main$ExportingModule = {$: 'ExportingModule'};
var $author$project$Main$GoTo = function (a) {
	return {$: 'GoTo', a: a};
};
var $author$project$Main$OpenLoadDialog = {$: 'OpenLoadDialog'};
var $author$project$Main$OpenLoginDialog = {$: 'OpenLoginDialog'};
var $author$project$Main$OpenLogoutDialog = {$: 'OpenLogoutDialog'};
...
var $author$project$Main$lastSaved = function (model) {
	var duration = A2($ianmackenzie$elm_units$Duration$from, model.saveModel.lastSaved, model.environment.currentTime);
	if (!model.saveModel.unsavedChanges) {
		...
		var _v0 = model.saveModel.loginState;
		switch (_v0.$) {
			case 'LoggedIn':
				return 'saving...';
			case 'NotLoggedIn':
...
var $author$project$Main$LoadMachine = function (a) {
...
var $author$project$Main$renderLoadList = F3(
	function (w, h, metas) {
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$LoadMachine(machine)),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Load a saved machine')
						])),
...
var $author$project$Main$modeButtons = function (model) {
	...
	var simulating = function () {
		var _v5 = model.appModel.present.appState;
		if (_v5.$ === 'Simulating') {
			return true;
		} else {
			return false;
	...
	var exporting = function () {
		var _v4 = model.appModel.present.appState;
		if (_v4.$ === 'Exporting') {
			return true;
		} else {
			return false;
	...
	var building = function () {
		var _v3 = model.appModel.present.appState;
		if (_v3.$ === 'Building') {
			return true;
		} else {
			return false;
			...
			[
				...
				switch (_v0.$) {
					case 'NotLoggedIn':
						return A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$notifyTap,
							$author$project$Main$OpenLoginDialog,
							A2(
								$MacCASOutreach$graphicsvg$GraphicSVG$move,
							...
							$MacCASOutreach$graphicsvg$GraphicSVG$group(
								_List_fromArray(
									[
										...
										A2(
										$MacCASOutreach$graphicsvg$GraphicSVG$notifyTap,
										$author$project$Main$OpenLogoutDialog,
										A2(
											$MacCASOutreach$graphicsvg$GraphicSVG$move,
											_Utils_Tuple2(40, 0),
											$MacCASOutreach$graphicsvg$GraphicSVG$group(
										...
										A2(
										$MacCASOutreach$graphicsvg$GraphicSVG$notifyTap,
										$author$project$Main$OpenLoadDialog,
										A2(
											$MacCASOutreach$graphicsvg$GraphicSVG$move,
											_Utils_Tuple2(40, -20),
											$MacCASOutreach$graphicsvg$GraphicSVG$group(
				...
				(!model.saveModel.editingName) ? A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$notifyTap,
				$author$project$Main$EditMachineName,
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$move,
					...
					A2(
						...
						A2(
							...
							16,
							$MacCASOutreach$graphicsvg$GraphicSVG$fixedwidth(
								$MacCASOutreach$graphicsvg$GraphicSVG$text(model.saveModel.machineMetadata.name)))))) : A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$move,
				_Utils_Tuple2(((-winX) / 2) + 325, (winY / 2) - 10),
				A5($author$project$Utils$textBox, model.saveModel.machineMetadata.name, 300, 20, 'Machine Name', $author$project$Main$TypeName)),
				A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$move,
				...
				A2(
					...
					A2(
						...
						$MacCASOutreach$graphicsvg$GraphicSVG$fixedwidth(
							$MacCASOutreach$graphicsvg$GraphicSVG$text(
								$author$project$Main$lastSaved(model)))))),
				function () {
				var _v1 = model.saveModel.loadDialog;
				switch (_v1.$) {
					case 'LoadNotOpen':
						return $MacCASOutreach$graphicsvg$GraphicSVG$group(_List_Nil);
					case 'LoadLoading':
							...
							_List_fromArray(
								[
									...
									A2(
										...
										$MacCASOutreach$graphicsvg$GraphicSVG$centered(
											$MacCASOutreach$graphicsvg$GraphicSVG$fixedwidth(
												$MacCASOutreach$graphicsvg$GraphicSVG$text('Loading')))))
								]));
					default:
						var metas = _v1.a;
						var _v2 = model.environment.windowSize;
						var w = _v2.a;
						var h = _v2.b;
						return A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$move,
							_Utils_Tuple2((-w) / 4, h / 4),
							A3(
								$MacCASOutreach$graphicsvg$GraphicSVG$html,
								w / 2,
								h / 2,
								A3($author$project$Main$renderLoadList, (w / 2) | 0, (h / 2) | 0, metas)));
				}
			}()
			]));
};
...
var $author$project$Main$main = $MacCASOutreach$graphicsvg$GraphicSVG$app(
	{
		init: F3(
			function (flags, url, key) {
				return _Utils_Tuple2(
					{appModel: $author$project$Main$initAppModel, environment: $author$project$Environment$init, saveModel: $author$project$Main$initSaveModel},
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								...
								$elm$browser$Browser$Dom$getViewport),
								$author$project$Main$getLoginStatus,
			...
			return $elm$core$Platform$Sub$batch(
				_List_fromArray(
					[
						...
						function (_v1) {
							return $author$project$Main$GetLoginStatus;
						}),
